            ...
            <div className="containerp">
                ...
                <div className="containerpp2">
                    ...
                    <Link to="/Reported">
                        <button
                            type="button"
                            className={`flex items-center justify-center text-gray-900 bg-white focus:outline-none hover:bg-gray-100 focus:ring-4 focus:ring-gray-100 font-medium rounded-full text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800 dark:text-white dark:border-gray-600 dark:hover:bg-gray-700 dark:hover:border-gray-600 dark:focus:ring-gray-700 ${clickedButton === 'button4' ? 'clicked' : ''}`}
                ...
                <div className="containerp3">
                    <form className='w-[450px] relative mb-5'>
                        ...
                        <button
                            ...
                            style={{ backgroundColor: '#FF9F1C', borderColor: '#FF9F1C', marginTop: '5px', }}
                            type="button"
                            onClick={s_post}
                        >
                            Search
                    ...
                    {postData.map(i => {
                        return (
                            ...
                            <Link to="/DetailsDelete2" state={i.post_id} class="cardsave bg-white border border-gray-200 rounded-lg shadow ">
                                <div className="pc3 flex flex-col justify-between p-4 ">
                                    ...
                                    <h5 className="mb-2 text-2xl font-bold tracking-tight text-gray-900 dark:text-white">{hashtagData[i.post_id] !== undefined ? hashtagData[i.post_id] : ''}</h5>
                                    <p className="mb-3 font-normal text-gray-700 dark:text-gray-400">{i.ingredient}</p>
                                    <div className="flex">
